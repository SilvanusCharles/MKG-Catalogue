  ...
  head: () => ({
    meta: [
      { title: "Contact — MKG Kabel" },
      {
        name: "description",
        content:
          "Contact MKG Kabel for cable orders, bulk pricing, and availability. Visit us at 185 Adeniji Adele Road, beside Wema Bank, Lagos Island, Lagos.",
      },
    ],
  }),
  component: Contact,
    ...
    <>
      <section className="bg-[color:var(--brand-black)] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <h1 className="mt-2 font-display font-black text-4xl md:text-6xl uppercase">
            Get in touch
          </h1>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16 grid md:grid-cols-2 gap-6">
          <a
            href={`tel:${PHONE}`}
            className="group bg-[color:var(--brand-black)] text-white p-8 hover:bg-[color:var(--brand-red)] transition-colors"
          >
            <Phone size={32} className="text-[color:var(--brand-red)] group-hover:text-white" />
            <h2 className="mt-4 font-display font-bold text-xs uppercase tracking-widest text-white/60 group-hover:text-white/80">
              Call to Order
            </h2>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group bg-[color:var(--brand-red)] text-white p-8 hover:bg-[color:var(--brand-red-dark)] transition-colors"
          >
            <MessageCircle size={32} />
            <h2 className="mt-4 font-display font-bold text-xs uppercase tracking-widest text-white/80">
              WhatsApp
            </h2>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-16 grid sm:grid-cols-2 gap-4">
          <div className="border border-border p-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              185 Adeniji Adele Road, beside Wema Bank, Lagos Island, Lagos — serving contractors
              nationwide.
            </p>
          </div>
          <div className="border border-border p-6">
