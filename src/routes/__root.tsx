...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional electrical cable supplier in Lagos, Nigeria. Cables, conduit, pipes & earthing imported direct from Turkey." },
      { property: "og:title", content: "MKG Kabel — Premium Cables & Conduit, Lagos" },
      { property: "og:description", content: "Professional electrical cable supplier in Lagos, Nigeria. Cables, conduit, pipes & earthing imported direct from Turkey." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MKG Kabel — Premium Cables & Conduit, Lagos" },
      { name: "twitter:description", content: "Professional electrical cable supplier in Lagos, Nigeria. Cables, conduit, pipes & earthing imported direct from Turkey." },
