...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MKG Kabel — Premium Cables & Conduit" },
      { property: "og:description", content: "Trusted by contractors and electricians across Nigeria — imported directly from Turkey." },
